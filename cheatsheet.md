...
watch -n 5 <command>		# rerun the command every 5 seconds
------------------------------------------------------------------
...
cp /etc/exports /etc/exports1.bak		# get a backup
...
showmount --exports 10.10.10.222		# list the available shares
sudo mount 10.10.10.222:/exports/backup /mnt/nfs/backup

---
autofs						# used for automatic mounting of shares and unmounting them while not in use

sudo apt install autofs

sudo nano /etc/auto.master: 
    /mnt/nfs /etc/auto.nfs --ghost --timeout=60		# add this line
sudo nano /etc/auto.nfs:
    backup -fstype=nfs4,rw 10.10.10.222:/exports/backup
    documents -fstype=nfs4,rw 10.10.10.222:/exports/documents
