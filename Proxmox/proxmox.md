...
# List the drives to find out which one contains the Virtio.iso
diskpart
list disk
list volume

# Load the driver in recovery drive
drvload E:\vioscsi\w10\amd64\vioscsi.inf

# confirm the loaded drives
diskpart
list volume

# install the driver
dism /Image:C:\ /Add-Driver /Driver:E:\viostor\w10\amd64\ /Recurse

# Reboot the system (Change boot order before)
wpeutil reboot
